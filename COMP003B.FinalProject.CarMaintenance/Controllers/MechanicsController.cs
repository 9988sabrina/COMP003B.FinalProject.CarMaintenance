...
namespace COMP003B.FinalProject.CarMaintenance.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Specialty")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Specialty")] Mechanic mechanic)
        {
            if (id != mechanic.Id)
            {
                return NotFound();
